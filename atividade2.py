...
def consultar_nota():
    ...
    id_aluno, nome_encontrado = aluno
    ...
    try:
        with open(ARQUIVO_NOTAS, "r", encoding="utf-8") as arquivo:
            ...
            for linha in arquivo:
                ...
                id_nota, disciplina, nota = dados[0], dados[1], dados[2]

                if id_nota == id_aluno and disciplina.lower() == disciplina_busca.lower():
                    print(f"\nAluno: {nome_encontrado}")
            ...
            if not encontrado:
                print(f"Nenhuma nota encontrada para essa disciplina.")
